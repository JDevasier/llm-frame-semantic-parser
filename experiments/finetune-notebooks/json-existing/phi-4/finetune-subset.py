...
train_prompts_df = pd.read_json(f'../fn1.7-train-prompts-{args.frac}.jsonl', lines=True)
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        seed = 3407,
        output_dir = f"output-phi-4-fsp-ft-{args.frac}",
...
# Save the model
model.save_pretrained(f"phi-4-fsp-ft-{args.frac}")
tokenizer.save_pretrained(f"phi-4-fsp-ft-{args.frac}")
