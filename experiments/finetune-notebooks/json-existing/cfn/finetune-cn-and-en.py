...
train_prompt_compl_dataset = pd.concat([train_prompt_compl_dataset, en_train_prompt_compl_dataset], ignore_index=True)
...
training_args = TrainingArguments(
    ...
    output_dir="./checkpoint_dir_cn_and_en",
)
...
pd.DataFrame(preds.predictions).to_csv("eng-and-chinese-preds.csv")