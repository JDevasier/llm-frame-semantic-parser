...
model, tokenizer = FastLanguageModel.from_pretrained(
    ...
    model_name="qwen-2.5-72b-fsp-ft",
...
if os.path.exists("fn1.7-test-predictions-temp.jsonl"):
    predictions = pd.read_json("fn1.7-test-predictions-temp.jsonl", lines=True)["predictions"].tolist()
...
pd.DataFrame(predictions, columns=["predictions"]).to_json("fn1.7-test-predictions-final.jsonl", lines=True, orient="records")
