...
train_prompts_df = pd.read_json('../fn1.7-train-lex-prompts.jsonl', lines=True)
...
trainer = SFTTrainer(
    ...
    args = TrainingArguments(
        ...
        seed = 3407,
        output_dir = "output-qwen-2.5-72b-fsp-cand-ft",
...
# Save the model
model.save_pretrained("qwen-2.5-72b-fsp-cand-ft")
tokenizer.save_pretrained("qwen-2.5-72b-fsp-cand-ft")
