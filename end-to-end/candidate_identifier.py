...
from english_spelling import gb2us, us2gb

class Config:
    def __init__(self):
        # Path to the Framenet data folder containing luIndex.xml, frameIndex.xml, frame and fulltext folders, etc.
        self.framenet_path = "./fndata-1.7"
        self.gb2us = gb2us
        self.us2gb = us2gb
